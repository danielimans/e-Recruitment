...
<body class="bg-gray-50 text-gray-800 antialiased font-sans">
    ...
    {{-- 
        DATA SETUP:
        Defining authentic Malaysian personas here so we can loop through them below.
    --}}
    @php
        $testimonials = [
            [
                ...
                'quote' =>
                    'I created my resume using the builder in 10 minutes. Applied to 3 jobs in Cyberjaya and got hired within a week!',
            ],
            [
                'name' => 'Wong Wei Meng',
                'role' => 'Marketing Manager',
                'quote' =>
                    'The application tracking system is a lifesaver. I never had to wonder where I stood in the hiring process. Highly recommended.',
            ],
            [
                'name' => 'Ravi Chandran',
                'role' => 'Graphic Designer',
                'quote' =>
                    'As a fresh graduate from Penang, I struggled to find openings. This platform connected me with employers looking exactly for my skill set.',
            ],
        ];
    @endphp
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                @foreach ($testimonials as $user)
                    <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition">
                        ...
                        <p class="text-gray-600 mb-6 italic">"{{ $user['quote'] }}"</p>
